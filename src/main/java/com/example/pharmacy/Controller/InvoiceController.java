...
public class InvoiceController {
    ...
    // CREATE
    @PostMapping
    public ApiResponse<?> create(@Valid @RequestBody InvoiceRequest req) {
    ...
    public ApiResponse<?> delete(@PathVariable Long id) {
        service.delete(id);
        return ApiResponse.ok("Invoice deleted successfully");
    }
    ...
    public ApiResponse<?> filter(
        ...
        Page<?> data = service.filter(invoiceNumber, paymentId, page, size, sortBy, sortDir);
        return ApiResponse.ok(data);
    }
}